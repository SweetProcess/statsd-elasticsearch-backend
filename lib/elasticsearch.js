...
function reformatData(items, type) {
    let payload = '';
...
function es_bulk_insert(listCounters, listTimers, listTimerData, listGaugeData) {
    ...
    let payload = reformatData(listCounters, elasticCountType);
    payload += reformatData(listTimers, elasticTimerType);
    payload += reformatData(listTimerData, elasticTimerDataType);
    payload += reformatData(listGaugeData, elasticGaugeDataType);
